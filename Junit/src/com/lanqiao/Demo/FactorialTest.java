...
public class FactorialTest {
	 ...
	 * { { 0, 0 }, // 0 { 1, 1 }, // 1 { 2, 2 }, // 2 { 120, 5 }, // 3 { 362880, 9
	 * }, // 4 { 3628800, 10 }, // 5 { 0, 11 }// 6 }; return Arrays.asList(obj); }
	 */
...
//		  //从txt文件中读取测试用例数据
//		  Object[][] obj = FileReader.readTxt("D:\\testData.txt",5, 2);//几行几列 
...
//	 
		 ...
		 * //测试用例数据集
		 * 
		 * @Parameters public static Collection<Object[]>testData() throws
		 * IOException,BiffException{ //从excel文件中读取测试用例数据
		 * 
		 * Object[][] obj =FileReader.readExcel("D:\\testData.xls", 0, 7, 2); return
		 * Arrays.asList(obj); }
		 */
	...
	public void testGetFactorial() {
		System.out.println("测试用例输入为：" + this.inputData + "\n测试用例预期输出: " + this.expected);
